<%-- 
    Document   : header
    Created on : Jan 1, 2016, 10:13:46 AM
    Author     : Bishal
--%>
...
<html>
  <head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="${SITE_URL}/static/css/AdminLTE.min.css">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="${SITE_URL}/static/css/skins/_all-skins.min.css">
    <!-- iCheck -->
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="${SITE_URL}/static/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Support Team
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="${SITE_URL}/static/img/ww.jpg" class="user-image" alt="User Image">
                  <span class="hidden-xs">Bishal Lama</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="${SITE_URL}/static/img/ww.jpg" class="img-circle" alt="User Image">
                    <p>
                      Bishal Lama - Java Developer
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-envelope"></i> <span>Product</span>
              </a>
            </li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-book"></i> <span>Enquiry</span>
              </a>
            </li>
            <li class="treeview">
              <a href="#">
